...
static const int COUNTER_CLOCKWISE = 1;//p0,p1,p2が反時計回りのある場合
static const int CLOCKWISE = -1;//p0,p1,p2 が時計回りになる場合
static const int ONLINE_BACK = 2;//p2,p0,p1 がこの順で同一直線上にある場合
static const int ONLINE_FRONT = -2;//p0,p1,p2 がこの順で同一直線上にある場合(4)
static const int ON_SEGMENT = 0;//p2 が線分 p0p1 上にある場合(5)
